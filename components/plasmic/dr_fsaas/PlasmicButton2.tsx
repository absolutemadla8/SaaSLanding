...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: TCYoctH-c-D/css
...
function PlasmicButton2__RenderFunc(props: {
  ...
  return (
    ...
    >
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___0DdZ8)}
                role={"img"}
              />
            ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: "View Documentation",
          value: args.children,
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__iK0DE)}
                role={"img"}
              />
            ),
